...
function enableButtons () {
	...
	btn = document.getElementById("input_greet_by_trump");
	btn.onclick = function() {greetTrump();};
	
	btn.value = "Click me for sending message";
}
...
function greetTrump() {
	var message = document.getElementById("trump_field").value;
